...
int sysctl_mptcp_sandy_mptcp=1;
EXPORT_SYMBOL(sysctl_mptcp_sandy_mptcp);
...
u32 sysctl_mptcp_scheduler_optimizations_disabled __read_mostly = 2;
...
static struct ctl_table mptcp_table[] = {
	{
                .procname = "mptcp_sandy_mptcp",
                .data = &sysctl_mptcp_sandy_mptcp,
                .maxlen = sizeof(int),
                .mode = 0644,
